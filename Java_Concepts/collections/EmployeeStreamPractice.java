...
//        System.out.println(employeeList.stream().max((e1,e2)-> (int) (e1.getSalary()- e2.getSalary())));

//        //emp joins after 2016m
...
//        System.out.println(employeeList.stream().filter(e -> e.getGender() == "Male" && e.getDepartment() == "Product Development").min((e1, e2) -> e1.getAge() - e2.getAge()).get());
...
//        }
        ...
        //no. of employer in each department
//    Map<String, Long> mp=   employeeList.stream().collect(Collectors.groupingBy(employee -> employee.getDepartment(),Collectors.counting()));
//        mp.keySet().stream().forEach(e-> System.out.println(e+" " +mp.get(e)));

        // find Details of youngest male and from product development department

//        Employee emp=employeeList.stream().filter(e1->e1.getDepartment()=="Product Development" && e1.getGender()=="Male").min((e1,e2)->e1.getAge()-e2.getAge()).get();
//        System.out.println(emp);

        //get emop name with highest salary

        Employee emp = employeeList.stream().max((e1,e2)-> (int) (e1.getSalary()-e2.getSalary())).get();
        System.out.println(emp);
